...
try {
    var BottomNavigation_1 = require("tns-core-modules/ui/bottom-navigation").BottomNavigation;
    registerElement("BottomNavigation", function () { return BottomNavigation_1; });
    var TabStrip_1 = require("tns-core-modules/ui/tab-navigation-base/tab-strip").TabStrip;
    registerElement("TabStrip", function () { return TabStrip_1; });
    var TabStripItem_1 = require("tns-core-modules/ui/tab-navigation-base/tab-strip-item").TabStripItem;
    registerElement("TabStripItem", function () { return TabStripItem_1; });
    var TabContentItem_1 = require("tns-core-modules/ui/tab-navigation-base/tab-content-item").TabContentItem;
    registerElement("TabContentItem", function () { return TabContentItem_1; });
    var Tabs_1 = require("tns-core-modules/ui/tabs").Tabs;
    registerElement("Tabs", function () { return Tabs_1; });
}
catch (e) { }
